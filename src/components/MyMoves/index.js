...
import InventoryDetailsItem from '../InventoryContent'
import './index.css'
...
class MyMoves extends Component {
  ...
  render() {
    ...
    const onClickViewMoveBtn = () => changeActiveId(estimateId)
    ...
    const getFromToAddressContainer = (
      <div className="from-to-address-container">
        ...
        <div className="estimate-id-container">
          ...
          <p className="from-to-address-description estimation-id">
            {estimateId}
          </p>
        </div>
      </div>
    ...
    const getMovingDetailsContainer = (
      <div className="moving-details-container">
        <div className="moving-details-item-container">
          <AiFillHome className="moving-details-item-logo" />
          <p className="moving-details-item-description">{propertySize}</p>
        </div>
        <div className="moving-details-item-container">
          <FaBoxes className="moving-details-item-logo" />
          <p className="moving-details-item-description">{totalItems}</p>
        </div>
        <div className="moving-details-item-container">
          <GiPathDistance className="moving-details-item-logo" />
          <p className="moving-details-item-description">{distance}</p>
        </div>
        <div className="moving-details-item-container">
          <BsCalendar2CheckFill className="moving-details-item-logo" />
